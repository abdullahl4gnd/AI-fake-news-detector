...
export default function ResultScreen() {
  ...
  const getStatusColor = (score: number) => {
    if (score >= 70) return '#10b981'; // Green - Real
    if (score >= 40) return '#f59e0b'; // Orange - Uncertain
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.resultCard}>
        ...
        <Text style={styles.confidenceText}>
          Confidence Level: {Math.round(submission.credibility_score)}%
        </Text>
      </View>
      ...
      <View style={styles.section}>
          ...
          <View style={styles.progressBar}>
            <View
              style={[
                styles.progressFill,
                {
                  width: `${submission.credibility_score}%`,
        ...
        <View style={styles.detailCard}>
          ...
          <View style={styles.progressBar}>
            <View
              style={[
                styles.progressFill,
                {
                  width: `${submission.text_fake_score}%`,
          ...
          <Text style={styles.detailValue}>
            {Math.round(submission.text_fake_score)}%
          </Text>
        </View>
        ...
        {submission.suspicious_words && (
          <View style={styles.detailCard}>
            ...
            <Text style={styles.suspiciousWords}>
              {submission.suspicious_words || 'None detected'}
            </Text>
          </View>
        )}
      ...
      <View style={styles.legendSection}>
        ...
        <View style={styles.legendItem}>
          ...
          <Text style={styles.legendText}>70-100%: Likely Real</Text>
        </View>
        <View style={styles.legendItem}>
          <View style={[styles.legendDot, { backgroundColor: '#f59e0b' }]} />
          <Text style={styles.legendText}>40-69%: Uncertain</Text>
        </View>
        <View style={styles.legendItem}>
          <View style={[styles.legendDot, { backgroundColor: '#ef4444' }]} />
          <Text style={styles.legendText}>0-39%: Likely Fake</Text>
        </View>
      </View>
    </ScrollView>
  );
