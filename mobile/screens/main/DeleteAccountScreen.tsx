...
export default function DeleteAccountScreen() {
  ...
  const handleDeleteAccount = async () => {
    if (!password.trim()) { Alert.alert('Error', 'Please enter your password to confirm'); return; }
    Alert.alert('Final Confirmation', 'Are you absolutely sure? This action cannot be undone.', [
      ...
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            editable={!loading}
          />
          <Text style={styles.hint}>Enter your password to confirm account deletion</Text>
        </View>

        <TouchableOpacity style={styles.deleteButton} onPress={handleDeleteAccount} disabled={loading}>
          {loading ? <ActivityIndicator color="#ffffff" /> : <Text style={styles.deleteButtonText}>Delete My Account</Text>}
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  warningIcon: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#ef444415', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#ef4444' },
  warningIconText: { fontSize: 40 },
  title: { fontSize: 28, fontWeight: 'bold', color: '#ffffff', textAlign: 'center', marginBottom: 24 },
  warningCard: { backgroundColor: '#ef444415', borderWidth: 1, borderColor: '#ef4444', borderRadius: 12, padding: 16, marginBottom: 32 },
  warningText: { fontSize: 14, color: '#ef4444', lineHeight: 20, textAlign: 'center', fontWeight: '600' },
  section: { marginBottom: 32 },
  sectionTitle: { fontSize: 16, fontWeight: '600', color: '#ffffff', marginBottom: 16 },
  consequenceItem: { flexDirection: 'row', marginBottom: 12, paddingLeft: 8 },
  bullet: { fontSize: 16, color: '#ef4444', marginRight: 12, fontWeight: 'bold' },
  consequenceText: { flex: 1, fontSize: 14, color: '#888888', lineHeight: 20 },
  ...
  cancelButton: { backgroundColor: '#111111', padding: 16, borderRadius: 12, alignItems: 'center', borderWidth: 1, borderColor: '#333333', marginBottom: 24 },
